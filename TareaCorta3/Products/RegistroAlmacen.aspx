<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistroAlmacen.aspx.cs" Inherits="TareaCorta3.Products.RegistroAlmacen" %>
            ...
            <div class="col-xs-6 col-md-5">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Registro de almacen</h3><br />
                    </div>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group text-center">
                                            <asp:Button ID="btnRegistrarAlmacen" Text="Registrar Almacen"  runat="server" CssClass="btn btn-primary btn-block" OnClick="btnRegistrarAlmacen_Click" />
                                        </div>
